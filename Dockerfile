...
RUN wget https://download.nextcloud.com/server/releases/nextcloud-11.0.0.tar.bz2 &&\
    bunzip2 nextcloud-11.0.0.tar.bz2 &&\
    tar xf nextcloud-11.0.0.tar &&\
    rm nextcloud-11.0.0.tar &&\
    mv nextcloud web &&\
